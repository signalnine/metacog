...
app.get("/authorize", async (c) => {
	...
	return renderApprovalDialog(c.req.raw, {
		...
		server: {
			description: "Summon voices from weight-space. Navigate corpus regions through stance declaration.",
			logo: "https://avatars.githubusercontent.com/u/314135?s=200&v=4",
			name: "Summon MCP Server",
		},
		state: { oauthReqInfo },
	});
});
 ...
 * metadata & the auth token as props passed to the MCP server.
 */
