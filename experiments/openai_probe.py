"""Probe OpenAI models via their REST API with metacog conditioning.
Useful for testing alignment evolution across the GPT lineage."""
import argparse
import json
import os
...
if __name__ == "__main__":
    ...
    print(query_openai(prompt, args.model))
